 ...
 * 此滑动条仅保证整数值情况下完整的
 */
export default class NumberSlider extends React.Component<NumberSliderProps, NumberSliderState> {
  ...
  handleSetPanResponder = (e: GestureResponderEvent, gesture: PanResponderGestureState) => {
    ...
    //
    // console.log('locationX, locationY', e.nativeEvent.locationX, e.nativeEvent.locationY);

...
import RCTGyroMap, { TYRCTGyroMapManager } from '../../../components/Basic/RCTGyroMap';
...
export default class GyroSweepMap extends Component<GyroSweepMapProps, IState> {
  static defaultProps = {
    mapBg: 0,
    isTopLeft: false,
    mapMatrix: 199,
      ...
      observable
        ...
        .reduce(
          (total, cur) => {
            ...
            const { pointsData = [], pilePosition = {}, currentPos = {}, subRecordId = 0 } = total;
  ...
  subscriptionLatestMediaData = async ({
    ...
    if (subRecordId !== this.state.subRecordId) await this.clearMapData();
  ...
  setMapData = (data: {
    ...
    const { pointsData = [], pilePosition = {}, currentPos = {}, subRecordId = 0 } = data;
  ...
  renderMap() {
    ...
    // console.warn('pointsData', pointsData, JSON.stringify(pointsData), 'pointColor', pointColor);

...
import { TYText, Utils, IconFont, I18N } from 'tuya-panel-kit';
    ...
    return (
      <View style={[styles.root, this.props.style]}>
        ...
        <TYText style={[styles.textStyle, fontStyle]}>
          {/* {defaultiI18n.getLang('emptyMap_title')} */}
        </TYText>
        <TYText style={[styles.textStyle, fontStyle]}>
          {/* {defaultiI18n.getLang('emptyMap_subTitle')} */}
        </TYText>
      </View>
    );
  }
  ...
  render() {
    ...
    return (
      <View style={[styles.root, this.props.style]}>
        <IconFont style={styles.icon} size={iconSize} color={iconColor} d={icon} />
        <TYText style={[styles.textStyle, fontStyle]}>
          {/* {defaultiI18n.getLang('drawMap_title')} */}
        </TYText>
      </View>
    );
  }

...
// 圆形loading 三种样式
class Circle extends PureComponent<CProps> {
  render() {
...
export class LoadingDoubleBounce extends Component<LProps, LState> {
  static defaultProps = {
    size: 14,
    color: '#000',
  };
...
export class LoadingBubbles extends Component<BProps, BState> {
  static defaultProps = {
    spaceBetween: 6,
    size: 11,
    color: '#000',
...
export class LoadingPulse extends Component<PProps, PState> {
  static defaultProps = {
    size: 14,
    color: '#000',
  };

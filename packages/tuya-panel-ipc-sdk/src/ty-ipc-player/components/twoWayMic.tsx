...
interface TwoWayMicState {}

class TwoWayMic extends React.Component<TwoWayMicProps, TwoWayMicState> {
  static defaultProps = {
    isFullScreen: false,
  };
  ...
  render() {
    ...
    return (
      ...
      >
        <View style={[styles.tipBox, tipBox]}>
          <TYText numberOfLines={1} style={[styles.textTip, textTip]}>
            {tipText}
          </TYText>
        </View>
      </View>

...
function toFixed16(v: string | number, length = 2) {
...
export const TYRCTTypeMapManager = NativeModules.TYRCTTypeMapManager; // 3.16激光地图区域框新接口(rnversion: 3.25)
...
export default class RCTLaserMap extends PureComponent<IRCTLaserMapProps, IRCTLaserMapState> {
  ...
  render() {
    const { style, onLaserMapPoints, onMapId, onLongPressInAreaView, onClickSplitArea, ...props } = this.props;
